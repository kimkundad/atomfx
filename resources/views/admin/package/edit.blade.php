    ...
    <div class="card-body">
      ...
      <form class="forms-sample" method="POST" action="{{$url}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="text_2" value="{{ $objs->text_2 }}">
        </div>
        <div class="form-group">
          <label for="exampleInputUsername1">ข้อความ 3</label>
          <input type="text" class="form-control" name="text_3" value="{{ $objs->text_3 }}">
        </div>
        <div class="form-group">
          <label for="exampleInputUsername1">ข้อความ 4</label>
          <input type="text" class="form-control" name="text_4" value="{{ $objs->text_4 }}">
        </div>
        <div class="form-group">
          <label for="exampleInputUsername1">Featured (ไม่ใช่ไม่ต้องใส่ อะไรลงไป)</label>
          <input type="text" class="form-control" name="text_5" value="{{ $objs->text_5 }}">
        </div>
